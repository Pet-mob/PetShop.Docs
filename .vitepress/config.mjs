...
export default defineConfig({
  ...
  description:
    "Documentação oficial da plataforma PetMob para petshops e tutores",
  lang: "pt-BR",
  ...
  themeConfig: {
      ...
      "/petshop-web/": [
        {
          ...
          items: [
            ...
            {
              text: "Cadastro do Petshop",
              link: "/petshop-web/primeiros-passos/cadastro",
            },
            { text: "Login", link: "/petshop-web/primeiros-passos/login" },
            {
              text: "Recuperar Senha",
              link: "/petshop-web/primeiros-passos/recuperar-senha",
            },
            {
              text: "Onboarding — Configuração Guiada",
              link: "/petshop-web/primeiros-passos/onboarding",
            },
            {
              text: "Configuração Inicial",
              link: "/petshop-web/primeiros-passos/configuracao-inicial",
            },
          ],
        },
        {
          text: "📊 Dashboard",
          collapsed: false,
          items: [{ text: "Visão Geral", link: "/petshop-web/dashboard/" }],
        },
        {
          text: "📅 Agenda",
          collapsed: false,
          items: [
            {
              ...
              link: "/petshop-web/agenda/visualizar",
            },
            {
              text: "Confirmar Agendamentos",
              link: "/petshop-web/agenda/confirmar",
            },
            {
              text: "Acompanhamento em Tempo Real",
              link: "/petshop-web/agenda/acompanhamento",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              link: "/petshop-web/clientes/historico",
            },
            {
              text: "Meus Pets (Animais)",
              link: "/petshop-web/clientes/animais",
            },
            { text: "Avaliações", link: "/petshop-web/clientes/avaliacoes" },
            {
              text: "Programa de Fidelidade",
              link: "/petshop-web/clientes/fidelidade",
            },
          ],
        },
        {
          ...
          items: [
            ...
            { text: "Relatórios", link: "/petshop-web/gestao/relatorios" },
            {
              ...
              link: "/petshop-web/gestao/relatorios-avancados",
            },
          ...
          items: [
            {
              ...
              link: "/petshop-web/configuracoes/dados-empresa",
            },
            {
              text: "Horário de Funcionamento",
              link: "/petshop-web/configuracoes/horario",
            },
            {
              text: "Serviços e Preços",
              link: "/petshop-web/configuracoes/servicos",
            },
            {
              text: "Link de Agendamento",
              link: "/petshop-web/configuracoes/link-agendamento",
            },
            {
              text: "Parâmetros",
              link: "/petshop-web/configuracoes/parametros",
            },
            {
              text: "Boost de Visibilidade",
              link: "/petshop-web/configuracoes/boost",
            },
            {
              text: "Planos e Preços",
              link: "/petshop-web/configuracoes/planos",
            },
            {
              text: "Assinatura",
              link: "/petshop-web/configuracoes/assinatura",
            },
            {
              text: "Financeiro",
              link: "/petshop-web/configuracoes/financeiro",
            },
            { text: "Contrato", link: "/petshop-web/configuracoes/contrato" },
            {
              text: "Fale Conosco",
              link: "/petshop-web/configuracoes/suporte",
            },
          ],
        },
      ],
      ...
      "/app-mobile/": [
        {
          ...
          items: [
            ...
            {
              text: "Cadastro e Login",
              link: "/app-mobile/primeiros-passos/cadastro",
            },
            {
              text: "Adicionar seu Pet",
              link: "/app-mobile/primeiros-passos/adicionar-pet",
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              text: "Perfil do Petshop",
              link: "/app-mobile/home/perfil-empresa",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              link: "/app-mobile/agendamentos/novo",
            },
            {
              text: "Acompanhar Status",
              link: "/app-mobile/agendamentos/status",
            },
            {
              text: "Histórico de Agendamentos",
              link: "/app-mobile/agendamentos/historico",
            },
          ],
        },
        {
          ...
          items: [
            { text: "Gerenciar Pets", link: "/app-mobile/meus-pets/gerenciar" },
            {
              ...
              link: "/app-mobile/meus-pets/vacinacao",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              link: "/app-mobile/fidelidade/pontos",
            },
          ],
        },
        {
    ...
    socialLinks: [{ icon: "github", link: "https://github.com/pet-mob" }],
