...
As notificações do app PetMob te mantém informado sobre tudo que importa — sem precisar abrir o app o tempo todo.

## Como acessar

Toque em **Perfil → Notificações**
...
Você pode ativar ou desativar cada tipo de notificação individualmente:

1. Acesse **Perfil → Notificações**
2. Use os toggles para ativar ou desativar cada categoria
3. As alterações são salvas automaticamente

---

## Ativando notificações no celular
...
✅ **Chegam mesmo com app fechado** — As notificações são push notifications e chegam mesmo que o app esteja fechado em segundo plano.

✅ **Central de notificações** — Todas as notificações recebidas ficam armazenadas em **Perfil → Notificações → Histórico** por 30 dias.

✅ **Notificações de retirada** — A notificação de "Pronto para retirada" é a mais importante e não pode ser desativada.
...
4. Se o problema persistir, saia e entre novamente na conta

**Recebi uma notificação mas ao abrir o app não encontrei nada. Por quê?**
Pode ser um agendamento que foi cancelado após a notificação ser enviada. Verifique a aba "Cancelados" no histórico.
