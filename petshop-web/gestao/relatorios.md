...
A tela de Relatórios fornece uma visão analítica do seu negócio. Use os dados para tomar decisões inteligentes: quais serviços mais vendem, qual período é mais movimentado, qual funcionário performa melhor.

## Como acessar

Menu lateral → **Gestão → Relatórios**
...
Exibe a evolução do faturamento dia a dia (ou semana a semana no modo mensal). Ideal para identificar sazonalidades e dias de maior movimento.
...
3. Escolha o formato:
   - **PDF** — Para impressão ou envio formal
   - **Excel (.xlsx)** — Para análises próprias
   - **CSV** — Para sistemas de gestão externos
...
✅ **Dados em tempo real** — Os relatórios refletem os dados atualizados ao abrir a página.

✅ **Gráficos interativos** — Passe o mouse sobre os pontos do gráfico para ver os valores exatos.

✅ **Período padrão** — Ao abrir, o relatório exibe o **mês atual** por padrão.

---

## Perguntas frequentes

**Os relatórios incluem agendamentos cancelados?**
Não. Apenas atendimentos com status "Concluído" entram nos relatórios financeiros.

**Posso agendar o envio automático de relatórios por e-mail?**
Esta funcionalidade está prevista em atualizações futuras.
