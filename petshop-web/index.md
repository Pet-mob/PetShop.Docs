# 🖥️ Painel do Petshop — Visão Geral

Bem-vindo ao guia do **Painel PetMob para Petshops**. Esta plataforma foi desenvolvida para simplificar a gestão do seu negócio: da agenda ao financeiro, tudo em um só lugar.
...
Use o menu lateral esquerdo para navegar entre as seções. No mobile, clique no ícone de menu no topo.

## Endereço do painel

Acesse seu painel em: **https://petshop.petmob.com.br**
