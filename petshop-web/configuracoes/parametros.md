...
A tela de Parâmetros controla o comportamento dos agendamentos — quantos clientes você aceita ao mesmo tempo, tempo entre atendimentos, confirmação automática e muito mais.

## Como acessar

Menu lateral → **Configurações → Parâmetros**
...
::: tip
**Confirmação automática** é ideal se você já tem horários bem definidos e não costuma recusar agendamentos. Agiliza o processo para o cliente e reduz sua carga operacional.
:::
...
✅ **Mudanças em tempo real** — Ao salvar, os parâmetros são aplicados imediatamente para novos agendamentos.

✅ **Agendamentos existentes** — Parâmetros alterados não afetam agendamentos já confirmados.

✅ **Capacidade respeitada** — Se todos os boxes estão ocupados em um horário, aquele slot não aparece como disponível no app.

---

## Perguntas frequentes

**Com confirmação automática, ainda posso cancelar um agendamento manualmente?**
Sim. Confirmação automática apenas elimina a etapa de aprovação manual. Você ainda pode cancelar qualquer agendamento a qualquer momento.

**Meus funcionários têm agendas separadas?**
No momento, a agenda é única por petshop. Agendas por funcionário estão previstas em atualizações futuras.
